...
class Game {
  ...
  renderStats () {
    ...
    this.context.fillText(`Lives: ${this.lives} | Score: ${this.bricksHit}`, this.canvas.width - 571, 16);
  ...
  renderResult () {
    ...
    this.context.fillStyle = "#FFFFFF";
    this.context.fillText(`Result: ${this.result} (press SPACE to restart)`, 54, 230);
    this.restart();
  }
